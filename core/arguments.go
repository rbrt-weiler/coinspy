...
func SetupFlags() {
	...
	pflag.BoolVar(&Config.Pushover.IncludeHost, "pushover-include-host", envordef.BoolVal("COINSPY_PUSHOVER_INCLUDE_HOST", false), "Include name of the host that sent the notification")
