...
func SetupFlags() {
	...
	pflag.StringVar(&Config.DuckDB.Table, "duckdb-table", envordef.StringVal("COINSPY_DUCKDB_TABLE", "crypto_rates"), "Table written to in DuckDB")
	...
	pflag.StringVar(&Config.QuestDB.Table, "questdb-table", envordef.StringVal("COINSPY_QUESTDB_TABLE", "crypto_rates"), "Table written to in QuestDB")
	...
	pflag.StringVar(&Config.SQLite3.Table, "sqlite3-table", envordef.StringVal("COINSPY_SQLITE3_TABLE", "crypto_rates"), "Table written to in SQLite3")
	...
	pflag.BoolVar(&Config.Pushover.IncludeHost, "pushover-include-host", envordef.BoolVal("COINSPY_PUSHOVER_INCLUDE_LINKS", false), "Include name of the host that sent the notification")
